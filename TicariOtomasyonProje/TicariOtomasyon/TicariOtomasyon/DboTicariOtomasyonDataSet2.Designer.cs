    ...
    public partial class DboTicariOtomasyonDataSet2 : global::System.Data.DataSet {
        ...
        public partial class TBL_FIRMALARDataTable : global::System.Data.TypedTableBase<TBL_FIRMALARRow> {
            ...
            private void InitClass() {
                ...
                this.columnYETKILISTATU.MaxLength = 20;
...
namespace TicariOtomasyon.DboTicariOtomasyonDataSet2TableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBL_FIRMALAR] WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = " +
                ...
                "ILCE] = @Original_ILCE)) AND ((@IsNull_VERGIDAIRESI = 1 AND [VERGIDAIRESI] IS NU" +
                "LL) OR ([VERGIDAIRESI] = @Original_VERGIDAIRESI)) AND ((@IsNull_ADRES = 1 AND [A" +
                "DRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD1 = 1 AND [O" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_FIRMALAR] ([AD], [YETKILISTATU], [YETKILIADSOYAD], [YETKILITC], [SEKTOR], [TELEFON1], [TELEFON2], [TELEFON3], [MAIL], [FAX], [IL], [ILCE], [VERGIDAIRESI], [ADRES], [OZELKOD1], [OZELKOD2], [OZELKOD3]) VALUES (@AD, @YETKILISTATU, @YETKILIADSOYAD, @YETKILITC, @SEKTOR, @TELEFON1, @TELEFON2, @TELEFON3, @MAIL, @FAX, @IL, @ILCE, @VERGIDAIRESI, @ADRES, @OZELKOD1, @OZELKOD2, @OZELKOD3);
SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRESI, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBL_FIRMALAR] SET [AD] = @AD, [YETKILISTATU] = @YETKILISTATU, [YETK" +
                ...
                "AIL, [FAX] = @FAX, [IL] = @IL, [ILCE] = @ILCE, [VERGIDAIRESI] = @VERGIDAIRESI, [" +
                ...
                "_YETKILITC)) AND ((@IsNull_SEKTOR = 1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Orig" +
                "inal_SEKTOR)) AND ((@IsNull_TELEFON1 = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] " +
                "= @Original_TELEFON1)) AND ((@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([T" +
                "ELEFON2] = @Original_TELEFON2)) AND ((@IsNull_TELEFON3 = 1 AND [TELEFON3] IS NUL" +
                "L) OR ([TELEFON3] = @Original_TELEFON3)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NU" +
                "LL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([" +
                "FAX] = @Original_FAX)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Origin" +
                "al_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE))" +
                " AND ((@IsNull_VERGIDAIRESI = 1 AND [VERGIDAIRESI] IS NULL) OR ([VERGIDAIRESI] =" +
                " @Original_VERGIDAIRESI)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRE" +
                "S] = @Original_ADRES)) AND ((@IsNull_OZELKOD1 = 1 AND [OZELKOD1] IS NULL) OR ([O" +
                "ZELKOD1] = @Original_OZELKOD1)) AND ((@IsNull_OZELKOD2 = 1 AND [OZELKOD2] IS NUL" +
                "L) OR ([OZELKOD2] = @Original_OZELKOD2)) AND ((@IsNull_OZELKOD3 = 1 AND [OZELKOD" +
                "3] IS NULL) OR ([OZELKOD3] = @Original_OZELKOD3)));\r\nSELECT ID, AD, YETKILISTATU" +
                ", YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL" +
                ", ILCE, VERGIDAIRESI, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRMALAR WHER" +
                "E (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON" +
                "2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRESI, ADRES, OZELKOD1, OZELKOD2, OZELK" +
                "OD3 FROM dbo.TBL_FIRMALAR";
